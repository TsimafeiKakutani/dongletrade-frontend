  ...
  return (
    <div className={classes.drawManuSide}>
      ...
      <div className={classes.drawLink}>
        <Link to="/my/dashboard" onClick={() => getCloseState(false)} style={{ textDecoration: 'none' }}>
      ...
      <div className={classes.drawLink}>
        <Link to="/my/security" onClick={() => getCloseState(false)} style={{ textDecoration: 'none' }}>
          <span className={classes.drawText}>
      ...
      <div className={classes.drawLink}>
        <Link to="/my/orders" onClick={() => getCloseState(false)} style={{ textDecoration: 'none' }}>
          <span className={classes.drawText}>
            <i className={clsx('icon-spot-order', classes.fs28)} />
            Orders
          </span>
        </Link>
      </div>
