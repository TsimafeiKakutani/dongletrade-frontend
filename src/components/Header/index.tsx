                ...
                <div style={{ marginTop: '5px' }}>
                  ...
                  <div className={classes.walover1}>
                    ...
                    <div className={classes.verifyDiv}>
                      <img src="images/verify.svg" className={classes.verifyIcon} alt="verify" />
                  ...
                  <div className={classes.splitbar} />
                  <div className={classes.walover} onClick={() => handleClickReferEarn()}>
                    <SupervisedUserCircleIcon className={classes.walletIcon} />
                    <div className={classes.walletText}>Refer and Earn</div>
                  </div>
