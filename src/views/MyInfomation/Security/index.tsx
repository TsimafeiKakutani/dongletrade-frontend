...
import SecurityHeaderActiveIcon from 'assets/image/security-header-active.png'
    ...
    <Box className={classes.container}>
      <Box className={classes.securityContainerHeader}>
        <Box display="flex" justifyContent="space-between" alignItems="center" maxWidth="1136px" width="100%">
          ...
          {securityInfo.EmailVerify && securityInfo.PhoneVerify ? (
            <img src={SecurityHeaderActiveIcon} alt="icon" />
          ) : (
